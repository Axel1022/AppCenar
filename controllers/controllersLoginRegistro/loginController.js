  ...
  if (req.method === 'GET') {
    ...
    try {
      ...
      if (user) {
        ...
        await user.save();
        console.log('token guardado en la base de datos y enviado por la url:', tokenUsuario);
      }
      ...
      const mailOption = {
        ...
        html: `
          ...
          <p>
            <a href="${req.protocol}://${req.get('host')}/recover-password/${tokenUsuario}">Recuperar Contraseña</a>
          </p>
      ...
      transporter.sendMail(mailOption, (err, info) => {
        if (err) {
          ...
          req.flash("success", "Se le envió un correo para seguir los pasos para cambiar la contraseña");
          return res.redirect("/Login");
        }
      });
